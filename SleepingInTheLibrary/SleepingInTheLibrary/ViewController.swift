    ...
    private func escapedParameters(_ parameters: [String:AnyObject]) -> String {
        ...
        if parameters.isEmpty {
            ...
            for (key, value) in parameters {
                ...
                // make sure that it is a string value, converts the value into a string
                let stringValue = "\(value)"
                
                // escape it, converts it to an ASCII compliant version of itself
            ...
            // joins each value in the dictionary with an & seperating it
